...
```bash
multipass launch 24.04 --disk 10G --memory 1G --cpus 1 --name srv-01 --cloud-init ./srv-01.yml
multipass launch 24.04 --disk 10G --memory 1G --cpus 1 --name srv-02 --cloud-init ./srv-02.yml 
```
